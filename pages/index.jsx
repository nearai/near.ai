    ...
    render() {
        ...
        return (
            <DocumentTitle title={ config.siteTitle }>
                <LandingPage landingKey="app_builder" title="Design and build a mobile app from scratch with NEAR." subtitle="No experience required." steps={steps} main_image="mobile_app.svg" />
            </DocumentTitle>
        )
    }
}
